...
//Guarda inicial
?><img src=/images/boleto/p.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
src=/images/boleto/b.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
src=/images/boleto/p.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
src=/images/boleto/b.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
<?php
$texto = $valor ;
if((strlen($texto) % 2) <> 0){
...
?>
    src=/images/boleto/p.png width=<?php echo $f1?> height=<?php echo $altura?> border=0><img 
<?php
    if (substr($f,$i,1) == "0") {
      $f2 = $fino ;
    }else{
...
?>
    src=/images/boleto/b.png width=<?php echo $f2?> height=<?php echo $altura?> border=0><img 
<?php
  }
}
...
// Draw guarda final
?>
src=/images/boleto/p.png width=<?php echo $largo?> height=<?php echo $altura?> border=0><img 
src=/images/boleto/b.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
src=/images/boleto/p.png width=<?php echo 1?> height=<?php echo $altura?> border=0> 
  <?php
} //Fim da função
